...
Page({
  ...
  to_sp(res) {
    ...
    if (this.data.s_refer == "" || this.data.s_refer == null) {
      dd.navigateTo({
        url: '/page/carInspectionIndex/inspection_approval/inspection_approval?station=1&id=' + id + ""
      });
    } else {
      dd.navigateTo({
        url: '/page/carInspectionIndex/inspection_approval/inspection_approval?type=1&station=1&id=' + id + ""
      });
    }
  }
});
