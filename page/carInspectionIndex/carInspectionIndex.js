      ...
      if(qx.nodeNum == 1){ //申请人
        //if(qx.station == 2 ){
          ym={
            ...
            list: [{
              ...
              title: '反馈申请',
              entitle: '',
              page: '/page/carInspectionIndex/inspection_apply/inspection_apply',
            } , {
              icon: '/image/jilu.png',
              title: '申请记录',
              entitle: '',
              page: '/page/carInspectionIndex/inspection_apply/list/list',
            // } , {
            //   icon: '/image/jilu.png',
            //   title: '离职审批',
            //   entitle: '',
        ...
        ym={
          ...
          list: [{
              ...
              title: '问题反馈审批',
              entitle: '',
              page: '/page/carInspectionIndex/inspection_approval/list/list',
            } ,
          ]
        }
      }
