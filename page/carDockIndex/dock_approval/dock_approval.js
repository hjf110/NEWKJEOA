...
Page({
  ...
  data: {
    ...
    trVehicleKpiShow:"",//KPI扣分显示
    trVehiclePenaltyAmountShow:"",//处罚金额显示
    trVehiclePaymentRatioShow:"",//赔付比例显示
    trVehiclePaymentMoneyShow:"",//赔付金额显示
      ...
      console.log("得到的事故地类别---", leList);
        ...
        app.ajaxSubmit(app.urlApi.nci_add_select, "GET", { id: thisId }, function(e) {//获得单条记录内容
          ...
          if(that.data.taskStatus == true ){
            that.setData({
              taskStatusShow: "事故车留存",
            })
          }else if(that.data.taskStatus == false ){
            that.setData({
              taskStatusShow: "事故车拖回",
            })
          }
        }
          //赋值事故地类别
          ...
          console.log("扣分扣钱的值为---", infoList.trVehicleKpi);
          //赋值扣分扣钱
          if (infoList.trVehicleKpi != null && infoList.trVehicleKpi != "") {
            that.setData({
              trVehicleKpiShow: infoList.trVehicleKpi,//扣分显示
              trVehiclePenaltyAmountShow: infoList. trVehiclePenaltyAmount,//扣钱显示
              trVehiclePaymentRatioShow: infoList.trVehiclePaymentRatio,//扣钱显示
              trVehiclePaymentMoneyShow: infoList.trVehiclePaymentMoney,//扣钱显示
              xjHidden: false,
            });
