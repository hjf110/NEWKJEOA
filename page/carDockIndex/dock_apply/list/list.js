...
Page({
  ...
  onLoad(){
    ...
    console.log("--------------------------新车问题反馈记录");
    console.log("用户的id为--", cid);
      app.ajaxSubmit(app.urlApi.ncd_add_list, "GET", { createId: cid }, function(res) {/******************反馈申请列表接口********************/
  ...
  to_sp(res) {
    ...
    dd.navigateTo({
      url: '/page/carDockIndex/dock_approval/dock_approval?type=1&id=' + id + "",/*******************反馈单号对应页面*********************/
    });
  }
