...
Page({
  ...
  tj: function(res) {
    ...
    if (this.data.text_yj == null || this.data.text_yj == "") {
      ...
      app.ajaxSubmit(app.urlApi.p_bum_yijian + "?station=" + station + "", "POST", { tcc: that.data.text_yj, id: that.data.id }, function(res) {
        console.log("得到的列表为", res);
        dd.alert({
          title: '信息',
          content: '提交成功,点击确定返回',
  ...
  yes_tj: function(res) {
    ...
    if (this.data.text_yj == null || this.data.text_yj == "") {
      ...
      // var station = app.userinfo.arr[0].station;
      console.log("station-----", station);
      app.ajaxSubmit(app.urlApi.p_bum_yijian + "?station=" + station + "", "POST", { tcc: "同意:" + that.data.text_yj, id: that.data.id }, function(res) {
        console.log("得到的列表为", res);
        // dd.alert({
        //   title: '信息',
        //   content: '提交成功,点击确定返回',
  ...
  no_tj: function(res) {
    ...
    if (this.data.text_yj == null || this.data.text_yj == "") {
      ...
      // var station = app.userinfo.arr[0].station;
      console.log("station-----", station);
      app.ajaxSubmit(app.urlApi.p_bum_yijian + "?station=" + station + "", "POST", { tcc: "不同意:" + that.data.text_yj, id: that.data.id }, function(res) {
        console.log("得到的列表为", res);
        // dd.alert({
        //   title: '信息',
        //   content: '提交成功,点击确定返回',
