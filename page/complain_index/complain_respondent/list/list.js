...
Page({
  ...
  onLoad(){
    ...
    console.log("用户的id为--", cid);
      app.ajaxSubmit(app.urlApi.cp_respondent_list, "GET", { respondent: cid }, function(res) {/****************问责督办申诉列表接口******************/
  ...
  to_sp(res) {
    ...
    dd.navigateTo({
      url: '/page/complain_index/complain_respondent/complain_respondent?type=1&id=' + id + "",/***************问责督办申诉单号对应页面**************/
    });
  }
